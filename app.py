...
# CSS: Renkli siyasi harita arka planı, 0.74 karartma, cam efektli kutular ve beyaz yazılar
st.markdown(
    """
    <style>
    .stApp {
        /* 0.74 Karartma ve Kendi GitHub Linkin */
        background-image: linear-gradient(rgba(5, 8, 15, 0.74), rgba(5, 8, 15, 0.74)), url("https://raw.githubusercontent.com/bcb77/erasmus-radar/main/Harita%20g%C3%B6rseli.jpg");
